...
{
    public class InteractiveTest : IClassFixture<GratsApiClientFactory<Startup>>, IDisposable
    {
        private readonly GratsApiClient _client;

        public InteractiveTest(GratsApiClientFactory<Startup> applicationFactory)
        {
