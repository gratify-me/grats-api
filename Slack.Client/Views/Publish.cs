...
namespace Slack.Client.Views
{
    ...
    {
        /// <summary>Id of the user you want publish a view to.</summary>
        ...
        /// <summary>A string that represents view state to protect against possible race conditions.</summary>
