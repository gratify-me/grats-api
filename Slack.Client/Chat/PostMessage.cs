...
{
    /// <summary>Arguments used by chat.postMessage https://api.slack.com/methods/chat.postMessage</summary>
    public class PostMessage : MessagePayload
    {
        ...
        /// <summary>Used in conjunction with thread_ts and indicates whether reply should be made visible to everyone in the channel or conversation. Defaults to false.</summary>
        /// <example>true</example>
